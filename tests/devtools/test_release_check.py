...
from devtools import cli, release_check, release_check_cli, release_check_manifest, release_check_notes
from devtools.release_check import Drift, facts_plan, render, run_checks, to_json
...
def test_cli_release_check_with_a_component_missing_its_docs_finds_the_manifest_drift(tmp_path, capsys):
    ...
    rc = cli.main(["release-check", "--root", str(tmp_path), "--manifest", str(manifest_path)])
